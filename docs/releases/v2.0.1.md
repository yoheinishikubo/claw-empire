...
- Scope: Discord direct-messenger bidirectional reliability update, including token-based channel discovery, inbound receiver polling, runtime status visibility, multilingual UX guidance, and targeted regression coverage.
