...
- [`v1.0.5`](v1.0.5.md) - Runtime modularization follow-up (route/workflow decomposition), `/api/inbox` security-doc parity (`x-inbox-secret`), OpenClaw config-path normalization hardening, and AI/Quick Start guide synchronization
