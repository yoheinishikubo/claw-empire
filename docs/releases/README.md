...
- [`v1.0.5`](v1.0.5.md) - Runtime modularization follow-up (route/workflow decomposition), `/api/inbox` security-doc parity (`x-inbox-secret`), one-time post-pull auto-migration (`INBOX_WEBHOOK_SECRET`/AGENTS/OpenClaw path), AGENTS secret-discovery hardening, and workflow crash hotfix
