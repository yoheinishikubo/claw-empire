# QA Connectivity Report (Task Session 2d80ffec-a66c-493d-963e-40d17f953f72)

- Team/owner: `QA/QC - Lint`
- Generated at (UTC): `2026-02-20T07:16:25.886Z`
...
|---|---|---|---:|---:|---:|
| LLM | `scripts/qa/llm-comm-test.mjs` | PASS | 200 | 1053ms | 0 |
| OAuth | `scripts/qa/oauth-comm-test.mjs` | PASS | 200 | 7ms | 0 |
| API | `scripts/qa/api-comm-test.mjs` | PASS | 200 | - | 0 |
...
- Evidence JSON: `logs/comm-check-2026-02-20T07-16-25-886Z.json`
- QA report: `docs/qa-connectivity-2d80ffec-a66c-493d-963e-40d17f953f72-report.md`

## Acceptance criteria

- HTTP status: `200`
- Max latency (SLA): `5000ms`
...
- API success rule: enabled providers return `ok=true` from `/api/api-providers/:id/test` within SLA

## Retry and escalation policy

- Retry: each failed item retried up to 1 time(s) in the same run context.
...
- API: PASS (Cerebras:PASS(183ms), Ollama:PASS(18ms))
- Overall: **PASS**
