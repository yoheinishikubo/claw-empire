# QA Connectivity Report (Task Session 2026-02-20T09-38-38-844Z)

- Team/owner: `QA/QC - Lint`
- Generated at (UTC): `2026-02-20T09:38:39.936Z`
...
|---|---|---|---:|---:|---:|
| LLM | `scripts/qa/llm-comm-test.mjs` | PASS | 200 | 1037ms | 0 |
| OAuth | `scripts/qa/oauth-comm-test.mjs` | FAIL | 200 | - | 0 |
| API | `scripts/qa/api-comm-test.mjs` | FAIL | 200 | - | 0 |
...
- Evidence JSON: `logs/comm-check-2026-02-20T09-38-39-937Z.json`
- QA report: `docs/qa-connectivity-2026-02-20T09-38-38-844Z-report.md`
...
- OAuth: FAIL (No connected OAuth provider found in /api/oauth/status.)
- API: FAIL (none)
- Overall: **FAIL**
