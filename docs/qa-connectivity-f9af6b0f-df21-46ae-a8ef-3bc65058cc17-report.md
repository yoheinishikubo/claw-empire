# QA Connectivity Report (Task Session f9af6b0f-df21-46ae-a8ef-3bc65058cc17)

- Team/owner: `QA/QC - Lint`
- Generated at (UTC): `2026-02-20T07:55:44.362Z`
...
|---|---|---|---:|---:|---:|
| LLM | `scripts/qa/llm-comm-test.mjs` | PASS | 200 | 1152ms | 0 |
| OAuth | `scripts/qa/oauth-comm-test.mjs` | PASS | 200 | 10ms | 0 |
| API | `scripts/qa/api-comm-test.mjs` | PASS | 200 | 200ms | 0 |
...
- Evidence JSON: `logs/comm-check-2026-02-20T07-55-44-364Z.json`
- QA report: `docs/qa-connectivity-f9af6b0f-df21-46ae-a8ef-3bc65058cc17-report.md`
