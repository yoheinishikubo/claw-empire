# QA Connectivity Report (Task Session 60ffbbd1-e060-4490-817e-9159c3146a20)

- Team/owner: `QA/QC - Lint`
- Generated at (UTC): `2026-02-20T09:26:28.762Z`
...
|---|---|---|---:|---:|---:|
| LLM | `scripts/qa/llm-comm-test.mjs` | PASS | 200 | 1271ms | 0 |
| OAuth | `scripts/qa/oauth-comm-test.mjs` | PASS | 200 | 22ms | 0 |
| API | `scripts/qa/api-comm-test.mjs` | PASS | 200 | 380ms | 0 |
...
- Evidence JSON: `logs/comm-check-2026-02-20T09-26-28-762Z.json`
- QA report: `docs/qa-connectivity-60ffbbd1-e060-4490-817e-9159c3146a20-report.md`
