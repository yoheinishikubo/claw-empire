# QA Connectivity Report (Task Session b0463b81-7b0d-4e30-8754-7c31e5dde810)

- Team/owner: `QA/QC - Lint`
- Generated at (UTC): `2026-02-20T07:18:03.387Z`
...
|---|---|---|---:|---:|---:|
| LLM | `scripts/qa/llm-comm-test.mjs` | PASS | 200 | 939ms | 0 |
| OAuth | `scripts/qa/oauth-comm-test.mjs` | PASS | 200 | 14ms | 0 |
| API | `scripts/qa/api-comm-test.mjs` | PASS | 200 | 189ms | 0 |
...
- Evidence JSON: `logs/comm-check-2026-02-20T07-18-03-388Z.json`
- QA report: `docs/qa-connectivity-b0463b81-7b0d-4e30-8754-7c31e5dde810-report.md`
